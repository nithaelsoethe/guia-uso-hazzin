  ...
  return (
    <article className="bg-white">
      <section className="bg-gradient-to-b from-hazzin-navy-deep to-hazzin-navy text-white">
        <div className="mx-auto w-full max-w-site px-4 sm:px-6 lg:px-16 py-10 sm:py-16 lg:py-24">
          <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-[10px] sm:px-4 sm:py-1.5 sm:text-[11px] font-semibold uppercase tracking-[0.2em] sm:tracking-[0.22em] text-white/70">
            Documento legal
          </span>
          <h1 className="mt-4 sm:mt-6 font-display text-[26px] sm:text-4xl lg:text-5xl font-extrabold leading-[1.1] sm:leading-[1.05] tracking-[-0.02em] sm:tracking-[-0.025em]">
            Termos de Uso
          </h1>
          <p className="mt-4 sm:mt-5 max-w-[60ch] text-[14px] sm:text-[15px] leading-[1.65] sm:leading-[1.7] text-white/70">
          ...
          <p className="mt-3 text-[11px] sm:text-[12.5px] uppercase tracking-[0.18em] text-white/55">
            Última atualização: 16 de junho de 2026
          </p>
        </div>
      </section>

      <section className="mx-auto w-full max-w-3xl px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-24 text-hazzin-ink">
        <div className="space-y-9 sm:space-y-12 text-[14.5px] sm:text-[15.5px] leading-[1.7] sm:leading-[1.75]">
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">1. Aceitação</h2>
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">2. Identificação</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">3. Finalidade do site</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">4. Uso aceitável</h2>
            <p className="mt-4 text-hazzin-ink/80">Você concorda em <strong>não</strong>:</p>
            <ul className="mt-4 space-y-2 list-disc pl-5 sm:pl-6 text-hazzin-ink/80 marker:text-hazzin-field-green">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">5. Propriedade intelectual</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">6. Produtos e aplicação</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">7. Limitação de responsabilidade</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">8. Links externos</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">9. Privacidade</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">10. Modificações</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">11. Foro</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">12. Contato</h2>
            <p className="mt-4 text-hazzin-ink/80">
