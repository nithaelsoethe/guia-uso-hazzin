    ...
    <article className="bg-white">
      ...
      <section className="mx-auto w-full max-w-3xl px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-24 text-hazzin-ink">
        <div className="space-y-9 sm:space-y-12 text-[14.5px] sm:text-[15.5px] leading-[1.7] sm:leading-[1.75]">
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">1. Quem somos</h2>
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">2. Dados que coletamos</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">3. Como usamos seus dados</h2>
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">4. Base legal</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">5. Compartilhamento</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">6. Cookies</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">7. Armazenamento e segurança</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">8. Retenção</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">9. Seus direitos como titular</h2>
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">10. Alterações</h2>
            <p className="mt-4 text-hazzin-ink/80">
          ...
          <div>
            <h2 className="font-display text-[19px] sm:text-2xl font-bold text-hazzin-navy-deep leading-[1.25]">11. Contato — encarregado de dados (DPO)</h2>
            <p className="mt-4 text-hazzin-ink/80">
