...
export default function Hero() {
  ...
  return (
    <section
      id="inicio"
      className="relative overflow-hidden bg-white pt-28 pb-16 sm:pt-32 sm:pb-24 lg:min-h-screen lg:flex lg:items-center"
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 bottom-0 h-24 sm:h-32 bg-gradient-to-b from-transparent to-hazzin-surface"
      />
      <div className="relative mx-auto w-full max-w-site px-5 sm:px-6 lg:px-16">
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
          <div className="order-2 lg:order-1 space-y-6 sm:space-y-8 animate-fade-in">
            ...
            <h1 className="font-display text-[34px] sm:text-5xl lg:text-6xl font-extrabold text-hazzin-navy-deep leading-[1.04] tracking-[-0.035em]">
              Guia de uso
              <br />
              <span
            ...
            <p className="max-w-[58ch] text-[15px] sm:text-[16.5px] lg:text-lg leading-[1.65] sm:leading-[1.7] text-hazzin-ink/70">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <button
                ...
                className="group relative inline-flex w-full sm:w-auto items-center justify-center sm:justify-start gap-3 overflow-hidden rounded-full px-6 sm:px-7 py-3.5 text-[14px] font-bold text-white ring-2 ring-hazzin-field-green/40 hover:-translate-y-0.5 sm:hover:pr-12 transition-all duration-500 ease-out-expo"
              >
          ...
          <div className="relative order-1 lg:order-2 animate-slide-in-right flex justify-center lg:justify-end">
            <img
              ...
              alt="Produtos Hazzin"
              className="relative w-full max-w-[260px] sm:max-w-[340px] lg:max-w-[480px] h-auto object-contain"
              loading="eager"
            />
          </div>
        </div>
